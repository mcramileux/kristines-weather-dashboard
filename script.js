    ...
    fetch(currentWeatherUrl)
        ...
        .then(function (data) {
            ...
            fetch("https://api.openweathermap.org/data/2.5/forecast?lat=" + data.coord.lat + "&lon=" + data.coord.lon + "&appid=1874cb6ef3fe4f96e520929bdea63f63&units=metric")
                ...
                .then(function (data) {
                    console.log(data)
                    document.getElementById("date-1").textContent = "Date: " + data.list[3].dt_txt 
                    ...
                    document.getElementById("date-2").textContent = "Date: " + data.list[4].dt_txt
                    ...
                    document.getElementById("date-3").textContent = "Date: " + data.list[5].dt_txt
                    ...
                    document.getElementById("date-4").textContent = "Date: " + data.list[6].dt_txt
                    ...
                    document.getElementById("date-5").textContent = "Date: " + data.list[7].dt_txt
