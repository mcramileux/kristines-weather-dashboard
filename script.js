    ...
    fetch(currentWeatherUrl)
        ...
        .then(function (data) {
            ...
            fetch("https://api.openweathermap.org/data/2.5/forecast?lat=" + data.coord.lat + "&lon=" + data.coord.lon + "&appid=1874cb6ef3fe4f96e520929bdea63f63&units=metric")
                ...
                .then(function (data) {
                    console.log(data)
                    document.getElementById("date-1").textContent = "Date: " + formatDate(data.list[1].dt_txt);
                    ...
                    document.getElementById("date-2").textContent = "Date: " + formatDate(data.list[9].dt_txt);
                    ...
                    document.getElementById("date-3").textContent = "Date: " + formatDate(data.list[17].dt_txt);
                    ...
                    document.getElementById("date-4").textContent = "Date: " + formatDate(data.list[25].dt_txt);
                    ...
                    document.getElementById("date-5").textContent = "Date: " + formatDate(data.list[33].dt_txt);
